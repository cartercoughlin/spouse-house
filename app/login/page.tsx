        ...
        <form onSubmit={handleAuth} className="mt-8 space-y-4">
          ...
          <div>
            <input
              ...
              required
              className="w-full px-4 py-3 text-cream-900 bg-white border border-peach-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-sage-500 placeholder:text-cream-500"
            />
          </div>
